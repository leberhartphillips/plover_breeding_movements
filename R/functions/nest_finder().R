find_plover_nests <- 
  function(tagging_data,
           ...
           nest_data,
           tag_year,
           start_md_of_breeding_season = "04-01",
           end_md_of_breeding_season = "08-01"){
    ...
    bird_tagging_data <- 
      ...
      filter(timestamp_local > ymd(paste(tag_year, start_md_of_breeding_season, sep = "-")) & 
              timestamp_local < ymd(paste(tag_year, end_md_of_breeding_season, sep = "-")))
