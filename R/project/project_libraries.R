...
packages_required_in_project <- 
  c(#"arm", "aspace","BaSTA","bayestestR","broom.mixed", "coefplot2", "cowplot",
    ...
    "leaflet.extras2", "leaflet", "RColorBrewer", "adehabitatLT", "lubridate", "RSQLite", "tidyverse", "sf", "ctmm", "readxl", "geosphere", "hms", "mgcv", "mapview", "geosphere", "ctmm", "moveVis"#, "rmdformats", "webshot2"
    )
